...
package asliborneo.router.PayServices;
...
public class Constants {
   ...
   */
  public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("MY", "GB");
   ...
   */
  public static final String PAYMENT_GATEWAY_TOKENIZATION_NAME = "ASLIBORNEOPAY";
