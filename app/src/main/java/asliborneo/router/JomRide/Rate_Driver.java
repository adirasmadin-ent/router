...
public class Rate_Driver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rating_detail_ref=database.getReference(Common.rateDetail_table);
        Driverinformationref=database.getReference(Common.Registered_driver);
    ...
    private void Submit_Rating_Detail() {
        ...
        rating_detail_ref.child(Common.driverId).push().setValue(rate).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                rating_detail_ref.child(Common.driverId).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Driverinformationref.child(Common.driverId).updateChildren(driver_rating_update).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
